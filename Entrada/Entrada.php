...
<?php include '../navbar.php'; ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h1>Entrada </h1>
                <a href="forminsert.php" class="btn btn-primary"><i class="fas fa-user-plus"></i> agregar Entrada</a>
...
foreach ($resultado as $documento) {
    echo "<tr>";
    echo "<td>" . $documento->entrada . "</td>";
    echo "<td>" . $documento->blog->titulo . "</td>";
	echo "<td>" . $documento->usuario->usuario . "</td>";
    echo '<td><a href="Editarentrada.php?id=' . $documento->_id . '" class="btn btn-primary"><i class="fas fa-edit"></i></a></td>';
    echo '<td><a href="Eliminarentrada.php?id=' . $documento->_id . '" class="btn btn-danger"><i class="fas fa-trash"></i></a></td>';
    echo "</tr>";
}
